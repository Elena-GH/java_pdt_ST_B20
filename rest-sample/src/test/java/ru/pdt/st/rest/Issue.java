...
public class Issue {
  ...
  public Issue withId(int id) {
    this.id = id;
    // Возвращаем тот же самый объект, в котором вызван метод т.е. метод модифицирует объект,
    // в котором он вызывается и позволяет дальше работать с этим объектом
    return this;
  }
